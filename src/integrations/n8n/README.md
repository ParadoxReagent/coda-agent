...
This integration acts as the bridge between your [n8n](https://n8n.io) automation workflows and coda. n8n workflows push events into coda via the event bus, and this integration lets the LLM query, summarize, and manage those events.
